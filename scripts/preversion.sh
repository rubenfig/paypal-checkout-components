...
modules='zoid post-robot zalgo-promise beaver-logger cross-domain-safe-weakmap @krakenjs/cross-domain-utils belter paypal-braintree-web-client grumbler-scripts paypal-sdk-constants'
